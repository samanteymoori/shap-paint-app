...
export function drawShapes ( shapes: Array<any>, drawingContext: any,selectedShape:any ): void {
    ...
    shapes.forEach( shape => {
      ...
      ctx.beginPath();
       ...
       // TEST Bounderies of each shape to select on canvas
        // ctx.beginPath();
        // ctx.strokeStyle = "red";
        // if(shapeProp.LowerBoundX!=null && shapeProp.UpperBoundX!=null&& shapeProp.UpperBoundY!=null&& shapeProp.LowerBoundY!=null)
        //     drawRectangle( {
        //         Shape: {},
...
export function clearCanvas ( drawingContext:any ): void {
    drawingContext.context.clearRect(0, 0, drawingContext.canvas.width, drawingContext.canvas.height)
}